...
var readChildren = function (node, typeChecker) {
...
var getRoute = function (node, entryPoints, program, host) {
    ...
    var childrenArray = readChildren(node, program.getTypeChecker());
    var children = [];
    if (childrenArray) {
...
var isRoute = function (n, typeChecker) {
    ...
    var children = !!readChildren(objLiteral, typeChecker);
...
exports.parseRoutes = function (tsconfig, exclude) {
    ...
    var toAbsolute = function (file) {
        return file.startsWith('/') ? file : path_1.join(process.cwd(), file);
    };
